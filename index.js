...
// utilizando map com função interna
// alunos.map((aluno) => {
//     document.write(`<h1>Bem vindo(a): ${nome}</h1>`);
// })
...
// utilizando arrow function com seus três parametros
...
document.write(`<h1>Existe alguem chamada Maeva? <br>${
...
document.write(`<h1>Ordenando o array numeros: ${numeros.sort((a, b) => b - a)}</h1>`);
